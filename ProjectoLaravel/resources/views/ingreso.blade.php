...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&family=Raleway:wght@400;700;900&display=swap"
        rel="stylesheet">
...
<body class="body-login">
    ...
    <div class="div-login">
        ...
        <form class="form-login" method="post" action="{{ url('ingreso/verificar') }}">
            @csrf
