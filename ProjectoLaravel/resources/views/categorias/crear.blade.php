...
@section('title', 'Categoría Registro')
...
@section('main-vista')
    <main class="admin">
        ...
        <div class="solicitud">
            ...
            <h2 class="solicitud__heading text-center degradado-admin">Crear Categoría</h2>

            <form action="{{ url('categorias') }}" method="post" class="solicitud__formulario">
                @csrf
                ...
                <div class="solicitud__boton">
                    <button type="submit" class="solicitud__btn">Registrar Categoría</button>
                </div>
